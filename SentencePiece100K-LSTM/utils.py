...
"""
def train_sentencepiece(code_file, model_prefix='spm_tokenizer'):
...
"""
def generate_code_completion(raw_code_snippet, model, sp, device, max_tokens=1, temperature=0.5, top_k=5):
    model.eval()
...
def save_in_single_file(code_snippet, output_file = "collected_code.py"):
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(code_snippet)
    print(f"Saved collected code to {output_file}")
