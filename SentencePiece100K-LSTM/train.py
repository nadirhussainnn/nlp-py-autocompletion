...
def main():
    ...
    vocab_training = "collected_code.py"

    """ Training the sentencepiece model using the collected code that contains code from first 100000 files """
    train_sentencepiece(vocab_training)
    ...
    code_snippet = open(dataset_file, "r").read()
...
if __name__ == "__main__":
    ...
    """ Collecting the code to train tokenizer files """
    base_dir = ""
    file_list = "py150_files/python100k_train.txt"
    
    NUM_FILES = 100000 # 100000 files are used to train the tokenizer in this particular case
    code_snippet = read_files(base_dir, file_list, NUM_FILES)

    """ Save the collected code in a single file """
    save_in_single_file(code_snippet, output_file="collected_code.py")
